...
public class WeatherServiceManager{
    ...
    public static void main(String[] args){
        ...
        System.out.println("Please enter a city and its state: ");
        String sCity1 = in.nextLine();
        System.out.println("Please enter another city and its state.");
        String sCity2 = in.nextLine();
        ...
        if(oCity1.getLowTemp() - oCity1.getHighTemp() > oCity2.getLowTemp() - oCity2.getHighTemp()) {
        // 		- Print out which city has the GREATEST RANGE between low and high.
            System.out.println("The city with the greatest range is " + oCity1.getCityName());
        } else {
            System.out.println("The city with the greatest range is " + oCity2.getCityName());
        }
		// ###### END: YOUR CODE HERE ######
    }
